            ...
            <div className="pc">
                <div className="background-main">
                    <div className="shadow-block">
                        ...
                        <img id="face" src={saw} className="App-logo" alt="logo" />
                        <div className="infos1">
                            <h2>Mr. Saw Thet Phyoe</h2>
                            <p id="pos1">Frontend Web Developer</p>
                            <img id="logo3" src={mail} alt="mail" />
                            <p><br />sawthet@dinger.asia</p>
                            <img id="logo1" src={linked} alt="linked" />
                            <p id="linkedin">Linkedin | <a href="https://www.linkedin.com/in/saw-thet-phyoe-69aa9b1b9/" target="_blank" rel="noreferrer"> Saw Thet Phyoe &nbsp;&nbsp;<i className="fa-solid fa-link"></i></a></p>
            ...
            <div className="hider">
                <div className="background">
                    ...
                    <div className="inner-block">
                        <img id="pf" src={saw} className="App-logo" alt="logo" />
                    </div>
                </div>
            </div>
        </div>
